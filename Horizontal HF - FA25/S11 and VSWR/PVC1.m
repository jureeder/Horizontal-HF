...
xline(14.000, 'label', '14.000');
xline(18.068, 'label', '18.068');
xline(21.450, 'label', '21.450');
xline(24.890, 'label', '24.890');

% Actual frequencies
xline(13.530, 'r', 'label', '13.530');
xline(16.060, 'r', 'label', '16.060');
xline(17.048, 'r', 'label', '17.048');
xline(18.036, 'r', 'label', '18.036');
xline(19.270, 'r', 'label', '19.270');
...
% Surrogate frequencies
xline(14.025, 'label', '14.025');
xline(14.150, 'label', '14.150');
xline(14.225, 'label', '14.225');
xline(14.350, 'label', '14.350');
xline(18.068, 'label', '18.068');
xline(18.168, 'label', '18.168');
...
fill([14.025, 14.025, 14.150, 14.150], Y_points, [0.8 0.8 0.8], 'FaceAlpha', 0.75, 'EdgeColor', 'none'); 
fill([14.225, 14.225, 14.350, 14.350], Y_points, [0.8 0.8 0.8], 'FaceAlpha', 0.75, 'EdgeColor', 'none'); 
fill([18.068, 18.068, 18.168, 18.168], Y_points, [0.8 0.8 0.8], 'FaceAlpha', 0.75, 'EdgeColor', 'none'); 
